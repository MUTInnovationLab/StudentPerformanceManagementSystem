...
export class DashboardPage implements OnInit {
  ...
  private allPages = [
    ...
    { title: 'HOD Analytics', path: '/hod-analytics', roles: ['HOD'], description: 'Department reports', icon: 'bar-chart-outline' }, // Removed Lecturer
    ...
    { title: 'Department Analytics', path: '/department-analytics', roles: ['HOD'], description: 'Department insights', icon: 'trending-up-outline' }, // Removed Lecturer
